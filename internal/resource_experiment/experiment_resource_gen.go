...
func ExperimentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"allocation": schema.NumberAttribute{
				Optional:            true,
				Computed:            true,
			...
			"primary_metrics": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"hypothesized_value": schema.NumberAttribute{
							Optional: true,
							Computed: true,
						},
						"name": schema.StringAttribute{
...
type ExperimentModel struct {
	Allocation                     types.Number `tfsdk:"allocation"`
...
func (t GroupsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	sizeVal, ok := sizeAttribute.(basetypes.NumberValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`size expected to be basetypes.NumberValue, was: %T`, sizeAttribute))
	}
...
type GroupsValue struct {
	...
	Size            basetypes.NumberValue `tfsdk:"size"`
...
func (t PrimaryMetricsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	hypothesizedValueVal, ok := hypothesizedValueAttribute.(basetypes.NumberValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`hypothesized_value expected to be basetypes.NumberValue, was: %T`, hypothesizedValueAttribute))
	}
...
type PrimaryMetricsValue struct {
	...
	HypothesizedValue  basetypes.NumberValue `tfsdk:"hypothesized_value"`
	Name               basetypes.StringValue `tfsdk:"name"`
...
func (v PrimaryMetricsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["hypothesized_value"] = basetypes.NumberType{}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
...
func (v PrimaryMetricsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	objVal, diags := types.ObjectValue(
		map[string]attr.Type{
			...
			"hypothesized_value": basetypes.NumberType{},
			"name":               basetypes.StringType{},
