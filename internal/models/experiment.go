...
type ExperimentAPIModel struct {
	...
	BenjaminiHochbergPerMetric     bool             `json:"benjaminiHochbergPerMetric"`
	BenjaminiHochbergPerVariant    bool             `json:"benjaminiHochbergPerVariant"`
	BenjaminiPrimaryMetricsOnly    bool             `json:"benjaminiPrimaryMetricsOnly"`
	BonferroniCorrection           bool             `json:"bonferroniCorrection"`
	BonferroniCorrectionPerMetric  bool             `json:"bonferroniCorrectionPerMetric"`
	CohortWaitUntilEndToInclude    bool             `json:"cohortWaitUntilEndToInclude"`
	CohortedAnalysisDuration       int64            `json:"cohortedAnalysisDuration,omitempty"`
	CohortedMetricsMatureAfterEnd  bool             `json:"cohortedMetricsMatureAfterEnd"`
	...
	IsAnalysisOnly                 bool             `json:"isAnalysisOnly"`
	...
	ScheduledReloadHour            int64            `json:"scheduledReloadHour"`
...
func ExperimentToAPIModel(ctx context.Context, experiment *resource_experiment.ExperimentModel) ExperimentAPIModel {
	return ExperimentAPIModel{
		Allocation:                     FloatFromNumberValue(experiment.Allocation),
		AllocationDuration:             Int64FromInt64Value(experiment.AllocationDuration),
		...
		BenjaminiHochbergPerMetric:     BoolFromBoolValue(experiment.BenjaminiHochbergPerMetric),
		BenjaminiHochbergPerVariant:    BoolFromBoolValue(experiment.BenjaminiHochbergPerVariant),
		BenjaminiPrimaryMetricsOnly:    BoolFromBoolValue(experiment.BenjaminiPrimaryMetricsOnly),
		BonferroniCorrection:           BoolFromBoolValue(experiment.BonferroniCorrection),
		BonferroniCorrectionPerMetric:  BoolFromBoolValue(experiment.BonferroniCorrectionPerMetric),
		CohortWaitUntilEndToInclude:    BoolFromBoolValue(experiment.CohortWaitUntilEndToInclude),
		CohortedAnalysisDuration:       Int64FromInt64Value(experiment.CohortedAnalysisDuration),
		CohortedMetricsMatureAfterEnd:  BoolFromBoolValue(experiment.CohortedMetricsMatureAfterEnd),
		...
		Duration:                       Int64FromInt64Value(experiment.Duration),
		FixedAnalysisDuration:          Int64FromInt64Value(experiment.FixedAnalysisDuration),
		...
		IsAnalysisOnly:                 BoolFromBoolValue(experiment.IsAnalysisOnly),
		...
		ScheduledReloadHour:            Int64FromInt64Value(experiment.ScheduledReloadHour),
		...
		SequentialTesting:              BoolFromBoolValue(experiment.SequentialTesting),
		...
		TargetExposures:                Int64FromInt64Value(experiment.TargetExposures),
...
func ExperimentFromAPIModel(ctx context.Context, diags diag.Diagnostics, experiment *resource_experiment.ExperimentModel, res ExperimentAPIModel) {
	experiment.Allocation = FloatToNumberValue(res.Allocation)
	experiment.AllocationDuration = Int64ToInt64Value(res.AllocationDuration)
	...
	experiment.BenjaminiHochbergPerMetric = BoolToBoolValue(res.BenjaminiHochbergPerMetric)
	experiment.BenjaminiHochbergPerVariant = BoolToBoolValue(res.BenjaminiHochbergPerVariant)
	experiment.BenjaminiPrimaryMetricsOnly = BoolToBoolValue(res.BenjaminiPrimaryMetricsOnly)
	experiment.BonferroniCorrection = BoolToBoolValue(res.BonferroniCorrection)
	experiment.BonferroniCorrectionPerMetric = BoolToBoolValue(res.BonferroniCorrectionPerMetric)
	experiment.CohortWaitUntilEndToInclude = BoolToBoolValue(res.CohortWaitUntilEndToInclude)
	experiment.CohortedAnalysisDuration = Int64ToInt64Value(res.CohortedAnalysisDuration)
	experiment.CohortedMetricsMatureAfterEnd = BoolToBoolValue(res.CohortedMetricsMatureAfterEnd)
	...
	experiment.Duration = Int64ToInt64Value(res.Duration)
	experiment.FixedAnalysisDuration = Int64ToInt64Value(res.FixedAnalysisDuration)
	...
	experiment.IsAnalysisOnly = BoolToBoolValue(res.IsAnalysisOnly)
	...
	experiment.ScheduledReloadHour = Int64ToInt64Value(res.ScheduledReloadHour)
	...
	experiment.SequentialTesting = BoolToBoolValue(res.SequentialTesting)
	...
	experiment.TargetExposures = Int64ToInt64Value(res.TargetExposures)
...
func GroupToAPIModel(ctx context.Context, group *resource_experiment.GroupsValue) GroupAPIModel {
	return GroupAPIModel{
		...
		Size:            FloatFromNumberValue(group.Size),
...
func GroupFromAPIModel(ctx context.Context, diags diag.Diagnostics, group *resource_experiment.GroupsValue, res GroupAPIModel) {
	...
	group.Size = FloatToNumberValue(res.Size)
...
func PrimaryMetricToAPIModel(ctx context.Context, metric *resource_experiment.PrimaryMetricsValue) MetricAPIModel {
	return MetricAPIModel{
		...
		HypothesizedValue: FloatFromNumberValue(metric.HypothesizedValue),
	}
}
...
func PrimaryMetricFromAPIModel(ctx context.Context, diags diag.Diagnostics, metric *resource_experiment.PrimaryMetricsValue, res MetricAPIModel) {
	...
	metric.HypothesizedValue = FloatToNumberValue(res.HypothesizedValue)
}
