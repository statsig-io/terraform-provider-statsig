...
func MetricSourceToAPIModel(ctx context.Context, metric_source *MetricSourceModel) MetricSourceAPIModel {
...
func MetricSourceFromAPIModel(ctx context.Context, diags diag.Diagnostics, metric_source *MetricSourceModel, res MetricSourceAPIModel) {
